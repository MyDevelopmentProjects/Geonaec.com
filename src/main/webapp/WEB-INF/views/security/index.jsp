...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="Naec">
    ...
    <!-- Events -->
    <link rel="stylesheet" href="/admin/libs/jquery/fullcalendar/dist/fullcalendar.css" type="text/css"/>
    <link rel="stylesheet" href="/admin/libs/jquery/fullcalendar/dist/fullcalendar.theme.css" type="text/css"/>
...
<script src="/admin/js/apps/snsettings.js"></script>
</body>
</html>
