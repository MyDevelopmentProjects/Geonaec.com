angular.module('app').controller('ScrollController', ['$scope', '$http', 'FileUploader', 'GridManager',  function ($scope, $http, FileUploader, GridManager) {
